...
export const SECTIONS: SectionContent[] = [
  ...
  },
  {
    ...
    content: [
      ...
      'Esta alternativa propone una plataforma tecnológica que centralice el expediente del operador, calcule automáticamente el score, segmente perfiles y sugiera asignaciones de ruta según criterios operativos. La decisión final quedaría en manos de un coordinator humano.',
